...
public class FragmentPeopleBindingImpl extends FragmentPeopleBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rotateLoading, 2);
    ...
    private FragmentPeopleBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.victor.loading.rotate.RotateLoading) bindings[2]
            );
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.brormoul.app.viewmodel.PeopleViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.brormoul.app.viewmodel.PeopleViewModel ViewModel) {
